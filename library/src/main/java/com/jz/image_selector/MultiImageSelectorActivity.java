...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback {
    ...
    public static void startSelect(Fragment fragment, int requestCode, int maxNum, int selectedMode, ArrayList<String> resultList) {
    ...
    public static void startSelect(Activity activity, int requestCode, int maxNum, int selectedMode, ArrayList<String> resultList, boolean showCamera, int mustCount) {
        Intent intent = new Intent(activity, MultiImageSelectorActivity.class);
        // 最大可选择图片数量
        intent.putExtra(MultiImageSelectorActivity.EXTRA_SELECT_COUNT, maxNum);
        // 选择模式
        ...
        intent.putStringArrayListExtra(MultiImageSelectorActivity.EXTRA_DEFAULT_SELECTED_LIST, resultList);
        //必选数量
        intent.putExtra(MultiImageSelectorActivity.MUST_COUNT, mustCount);
        intent.putExtra(MultiImageSelectorFragment.EXTRA_SHOW_CAMERA,showCamera);
        activity.startActivityForResult(intent, requestCode);
    }

    public static void startSelect(Fragment fragment, int requestCode, int maxNum, int selectedMode, ArrayList<String> resultList, boolean showCamera, int mustCount) {
        Intent intent = new Intent(fragment.getActivity(), MultiImageSelectorActivity.class);
        // 最大可选择图片数量
        intent.putExtra(MultiImageSelectorActivity.EXTRA_SELECT_COUNT, maxNum);
        // 选择模式
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isShow = intent.getBooleanExtra(EXTRA_SHOW_CAMERA, true);//默认显示照相机
